...
import SubHeader from 'src/components/HotMarketPage/SubHeader'
import styles from 'src/components/style.module.css'

const CurrentMarket = lazy(() => import('src/components/HotMarketPage/CurrentMarket'))
const MarketProvider = lazy(() => import('src/components/HotMarketPage/MarketProvider'))
const MarketLists = lazy(() => import('src/components/HotMarketPage/MarketRoutes'))
